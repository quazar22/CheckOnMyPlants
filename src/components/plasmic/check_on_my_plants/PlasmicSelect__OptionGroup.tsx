...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: Yx55jS_MRtW/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: y4GUXOimSgD/render
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__hApz)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__chFhd)}
              />
            </React.Fragment>
          ),
          value: args.children
