...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: JbK9iJBvnlA/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: OUgkoCY4UWb/render
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__fxaZ3)}
              >
                <div
                  className={classNames(
                    projectcss.all,
              ...
              <Select__Option
                className={classNames("__wab_instance", sty.option__coRqm)}
              />
            </React.Fragment>
          ),
          value: args.children
