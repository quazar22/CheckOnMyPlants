...
import Select__Overlay from "../../Select__Overlay"; // plasmic-import: 14TUHq322eD/component
...
import sty from "./PlasmicSelect.module.css"; // plasmic-import: y4GUXOimSgD/css
            ...
            >
              {p.renderPlasmicSlot({
                defaultContents: (
                  <React.Fragment>
                    <Select__Option
                      className={classNames("__wab_instance", sty.option__zKWA)}
                    ...
                    <Select__Option
                      className={classNames("__wab_instance", sty.option__n1V6)}
