...
import Select__Overlay from "../../Select__Overlay"; // plasmic-import: AU3dCJwZFbK/component
...
import sty from "./PlasmicSelect.module.css"; // plasmic-import: OUgkoCY4UWb/css

import ChevronDownsvgIcon from "./icons/PlasmicIcon__ChevronDownsvg"; // plasmic-import: H0_XKBB6dKi/icon
import ChevronUpsvgIcon from "./icons/PlasmicIcon__ChevronUpsvg"; // plasmic-import: TZ8FImDZHig/icon
            ...
            >
              {p.renderPlasmicSlot({
                defaultContents: (
                  <React.Fragment>
                    <Select__Option
                      className={classNames("__wab_instance", sty.option__vB61)}
    ...
    props = {
      ...
      children: (
        <React.Fragment>
          ...
          <Select__Option
            className={classNames("__wab_instance", sty.option__xsCfY)}
            value={"value2" as const}
          >
            {"Option 2"}
          </Select__Option>
